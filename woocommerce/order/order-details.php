...
<section class="woocommerce-order-details">
	...
	<table class="woocommerce-table woocommerce-table--order-details shop_table order_details">
		...
		<thead>
			<tr>
				<th class="woocommerce-table__product-name product-name"><?php esc_html_e( 'Vehicle & Information', 'woocommerce' ); ?></th>
		...
		<tfoot>
			...
			foreach ( $order->get_order_item_totals() as $key => $total ) {
				...
				if(!stristr($total['label'], 'total') && !stristr($total['label'], 'deposit')):
					?>
						...
						<tr class="fee-<?php echo sanitize_title($total['label']); ?>">
			...
			<?php if($_DEPOSIT_PERCENTAGE && $_BALANCE > 0): ?>
				...
				<tr class="fee-<?php echo sanitize_title('Deposit Percentage'); ?>">
					<th scope="row"><?php echo esc_html( 'Deposit ('.$_DEPOSIT_PERCENTAGE.'):' ); ?></th>
					<td><?php echo  wc_price($_AMOUNT_PAID); ?></td>
				</tr>
			...
			<tr class="fee-<?php echo sanitize_title($_TOTAL_TITLE); ?>">
				<th scope="row"><?php echo esc_html( $_TOTAL_TITLE ); ?></th>
				<td><?php echo  wc_price($_BALANCE); ?></td>
			</tr>
